...
Rob Conery は、テスト データおよびグローバリゼーションに関する問題に対処する、データベースをリファクタリング Damien Guard で動作します。

[&#9654;ビデオでは (11 分)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-mvc-storefront-part-5-globalization)
