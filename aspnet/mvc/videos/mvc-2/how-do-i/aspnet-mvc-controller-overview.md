...
---
<a name="aspnet-mvc-controller-overview"></a>ASP.NET MVC コント ローラーの概要
====================
によって[Stephen Walther](https://github.com/StephenWalther)

このビデオで Stephen Walther 紹介 ASP.NET MVC のコント ローラーとコント ローラーのアクションにします。 さまざまな種類のアクションの結果を返す方法を学習します。

[&#9654;ビデオでは (5 分)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-mvc-controller-overview)
