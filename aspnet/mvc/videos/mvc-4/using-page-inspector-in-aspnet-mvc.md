...
ms.locfileid: "26503681"
---
<a name="using-page-inspector-in-aspnet-mvc"></a>ASP.NET MVC フォーム内での Page Inspector の使用
====================
Tim Ammann によって

ビデオでは、ASP.NET MVC web アプリケーションで Page Inspector の使用方法について説明します。 [チュートリアルを参照します。](../../overview/views/using-page-inspector-in-aspnet-mvc.md)

[& #9654 です。ビデオでは (6 分)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/using-page-inspector-in-aspnet-mvc)
