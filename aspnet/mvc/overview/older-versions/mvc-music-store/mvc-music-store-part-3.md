...
## <a name="adding-a-view-template"></a><span data-ttu-id="2893a-114">ビューのテンプレートを追加します。</span><span class="sxs-lookup"><span data-stu-id="2893a-114">Adding a View template</span></span>
