...
3. MVC 5 と Web API 2 と互換性のある、プロジェクトを使用するすべてのパッケージを確認します。 以下の表に示します MVC 4 Web API は、パッケージを関連するよりも、変更する必要があります。 以下に示すパッケージのいずれかに依存しているパッケージがある場合は、MVC 5 と Web API 2 と互換性がある新しいバージョンを取得する発行者に問い合わせてください。 場合は、それらのパッケージのソース コードがある場合は、新しい MVC 5 と Web API 2 のアセンブリに再コンパイルする必要があります。   
    ...
    | Microsoft.AspNet.Mvc | は、4.0.x.x | 5.0.0 |
    | Microsoft.AspNet.Mvc.Facebook | は、4.0.x.x | 5.0.0 |
    | Microsoft.AspNet.WebApi.Core | は、4.0.x.x | 5.0.0 |
    | Microsoft.AspNet.WebApi.SelfHost | は、4.0.x.x | 5.0.0 |
    | Microsoft.AspNet.WebApi.Client | は、4.0.x.x | 5.0.0 |
    | Microsoft.AspNet.WebApi.OData | は、4.0.x.x | 5.0.0 |
    | Microsoft.AspNet.WebApi | は、4.0.x.x | 5.0.0 |
    | Microsoft.AspNet.WebApi.WebHost | は、4.0.x.x | 5.0.0 |
    | Microsoft.AspNet.WebApi.Tracing | は、4.0.x.x | 5.0.0 |
    | Microsoft.AspNet.WebApi.HelpPage | は、4.0.x.x | 5.0.0 |
    | Microsoft.Net.Http | 2.0.x です。 | 2.2.x です。 |
