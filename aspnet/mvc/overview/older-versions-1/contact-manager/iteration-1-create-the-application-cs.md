...
**図 01**: [新しいプロジェクト] ダイアログ ボックス ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image2.png))
...
**図 02**:、単体テスト プロジェクトの作成 ダイアログ ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image4.png))
...
**図 03**: ソリューション エクスプ ローラー ウィンドウ ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image6.png))
...
**図 04**: 新しい Microsoft SQL Server Express データベースを作成する ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image8.png))
...
**図 05**: データベース テーブル デザイナー ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image10.png))
...
**図 06**: [新しい項目の追加] ダイアログ ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image12.png))
...
**図 07**: モデルのコンテンツの選択 ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image14.png))
...
**図 08**: データ接続の選択 ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image16.png))
...
**図 09**: データベース オブジェクトの選択 ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image18.png))
...
**図 10**: 連絡先クラス ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image20.png))
...
**図 11**: Home コント ローラーを追加する ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image22.png))
...
**図 12**: インデックス ビューの追加 ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image24.png))


**ビューの追加**ダイアログ ボックスで、チェック ボックス ラベルの付いた**厳密に型指定されたビューを作成**です。 ビューのデータ クラス ContactManager.Models.Contact とビューのコンテンツの一覧を選択します。 これらのオプションを選択するには、連絡先のレコードの一覧を表示するビューが生成されます。
...
**図 13**: ビューの追加 ダイアログ ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image26.png))
...
**図 14**: デバッグの有効化 ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image28.png))
...
**図 15**:、インデックス ビュー ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image30.png))
...
**4 - controllers \homecontroller.cs (のメソッドを作成する) を一覧表示します。**
...
**図 16**: 作成ビューの追加 ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image32.png))


**ビューの追加**ダイアログで、選択、 **ContactManager.Models.Contact**クラスおよび**作成**コンテンツの表示のオプション (図 17 を参照してください)。 クリックすると、**追加** ボタン、ビューが自動的に生成される作成します。
...
**図 17**: 分解ページが表示されて ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image34.png))
...
**図 18**: ビューの作成 ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image36.png))
...
**6 - controllers \homecontroller.cs (の編集メソッド) を一覧表示します。**
...
**図 19**: ビューの編集を追加する ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image38.png))
...
**図 20**: 削除の確認ビュー ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image40.png))
...
**図 21**: 編集リンクを使用してビューにインデックス ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image42.png))
...
**図 22**: 削除の確認ビューの追加 ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image44.png))
...
この問題は、簡単に修正します。 最初に、Home コント ローラーの名前をリファクターする必要があります。 HomeController クラスを Visual Studio コード エディターで開く、クラスの名前を右クリックし、メニュー オプションを選択**名前の変更をリファクタリング**です。 このメニュー オプションを選択すると、名前の変更 ダイアログが開きます。
...
**図 23**: コント ローラーの名前をリファクタリング ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image46.png))
...
**図 24**: 名前の変更 ダイアログを使用して ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image48.png))
...
**図 25**: 既定のコント ローラーなし ([フルサイズのイメージを表示するをクリックして](iteration-1-create-the-application-cs/_static/image50.png))
