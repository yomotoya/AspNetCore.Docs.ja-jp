...
VSDBCMD の詳細については、次を参照してください。 [VSDBCMD のコマンド ライン リファレンスです。EXE (配置とスキーマのインポート)](https://msdn.microsoft.com/en-us/library/dd193283.aspx)と[する方法: VSDBCMD を使用して、コマンド プロンプトからの展開をデータベースを準備します。EXE](https://msdn.microsoft.com/en-us/library/dd193258.aspx)です。
...
- [Visual Studio 2010 の SQL Server データベース プロジェクト](https://msdn.microsoft.com/en-us/library/ff678491.aspx)
- [データベースの変更を管理します。](https://msdn.microsoft.com/en-us/library/aa833404.aspx)
- [方法: VSDBCMD を使用して、コマンド プロンプトからの展開をデータベースを準備します。EXE](https://msdn.microsoft.com/en-us/library/dd193258.aspx)
- [データベースのビルドと配置の概要](https://msdn.microsoft.com/en-us/library/aa833165.aspx)
