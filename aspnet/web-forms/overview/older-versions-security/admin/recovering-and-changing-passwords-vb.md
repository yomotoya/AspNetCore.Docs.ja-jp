...
**図 4**: います彼の新しいパスワードを使用してメールをユーザーが送信されます ([フルサイズの画像を表示する をクリックします。](recovering-and-changing-passwords-vb/_static/image12.png))。
...
**図 8**: An 電子メール メッセージの通知ユーザーをそのパスワードが変更 ([フルサイズの画像を表示する をクリックします](recovering-and-changing-passwords-vb/_static/image24.png))。
