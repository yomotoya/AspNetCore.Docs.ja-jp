...
**図 2**: の既定のワークフローにつながる混乱を招くサイクル ([フルサイズの画像を表示する をクリックします](user-based-authorization-cs/_static/image6.png))。
...
**図 4**: Your アプリケーションする必要がありますが含まれてという 2 つ`Web.config`ファイル ([フルサイズの画像を表示する をクリックします](user-based-authorization-cs/_static/image12.png))。
...
**図 5**: URL 承認規則匿名アクセスを禁止するため、私たちは、ログイン ページにリダイレクトされます ([フルサイズの画像を表示する をクリックします。](user-based-authorization-cs/_static/image15.png))。
...
**図 8**: 選択したファイルの内容がテキスト ボックスに表示されます ([フルサイズの画像を表示する をクリックします](user-based-authorization-cs/_static/image24.png))。
...
**図 13**: Tito は表示列の削除 ([フルサイズの画像を表示する をクリックします](user-based-authorization-cs/_static/image39.png))。
