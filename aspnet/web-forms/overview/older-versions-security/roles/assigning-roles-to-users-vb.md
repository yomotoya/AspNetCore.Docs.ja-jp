...
ms.locfileid: "37839779"
---
<a name="assigning-roles-to-users-vb"></a>(VB) のユーザーにロールの割り当てください。
====================
...
**図 2**: ページは、ユーザーおよびロールが表示されます ([フルサイズの画像を表示する をクリックします](assigning-roles-to-users-vb/_static/image6.png))。
...
**図 7**: GridView を「削除」ボタンを追加 ([フルサイズの画像を表示する をクリックします](assigning-roles-to-users-vb/_static/image21.png))。
...
**図 10**: Tito はスーパーバイザーでもう一度です。  ([フルサイズの画像を表示する をクリックします](assigning-roles-to-users-vb/_static/image30.png))。
...
**図 11**:「を指定のロール」を追加`WizardStep`CreateUserWizard に ([フルサイズの画像を表示する をクリックします](assigning-roles-to-users-vb/_static/image33.png))。
