...
**図 4**: ことを確認するブレークポイントを使用している、`Application_Start`イベント ハンドラーが実行されている ([フルサイズの画像を表示する をクリックします](caching-data-at-application-startup-vb/_static/image8.png))。
...
**図 7**: GridView で [仕入先データのキャッシュが表示されます ([フルサイズの画像を表示する] をクリックします](caching-data-at-application-startup-vb/_static/image17.png))。
