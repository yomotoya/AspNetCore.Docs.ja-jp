...
ms.locfileid: "37819346"
---
<a name="paging-and-sorting-report-data-c"></a>レポート データ (c#) のページングと並べ替え
====================
...
**図 8**: ページングが有効で、一度にレコードのサブセットのみが表示されます ([フルサイズの画像を表示する をクリックします](paging-and-sorting-report-data-cs/_static/image14.png))。
...
**図 12**: The 結果並べ替えられた順序の昇順で UnitPrice によって ([フルサイズの画像を表示する をクリックします](paging-and-sorting-report-data-cs/_static/image26.png))。
