...
**図 1**: DetailsView で Grid-Like レイアウト表示から、FormView が中断されます ([フルサイズの画像を表示する をクリックします](using-the-formview-s-templates-cs/_static/image3.png))。
