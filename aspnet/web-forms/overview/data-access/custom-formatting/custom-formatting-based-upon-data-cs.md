...
**図 2**:、DetailsView コントロール表示製品の 1 つずつ ([フルサイズの画像を表示する をクリックします](custom-formatting-based-upon-data-cs/_static/image6.png))。
...
**図 4**: 標準フォントで $75.00 より低い価格が表示されます ([フルサイズの画像を表示する をクリックします](custom-formatting-based-upon-data-cs/_static/image10.png))。
...
**図 7**: の製品で、十分に大きい Units In Stock"、"カスタム書式の適用 ([フルサイズの画像を表示する をクリックします](custom-formatting-based-upon-data-cs/_static/image17.png))。
...
**図 8**: これら製品での値が 10 以下の在庫数単位が赤で表示されます ([フルサイズの画像を表示する をクリックします](custom-formatting-based-upon-data-cs/_static/image20.png))。
