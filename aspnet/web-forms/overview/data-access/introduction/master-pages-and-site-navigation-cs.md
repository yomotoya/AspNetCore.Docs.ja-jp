...
**図 1**: このチュートリアルの「最後の結果 ([フルサイズ画像を表示する をクリックします。](master-pages-and-site-navigation-cs/_static/image3.png))
...
**図 3**: web サイトに新しいマスター ページを追加 ([フルサイズの画像を表示する をクリックします](master-pages-and-site-navigation-cs/_static/image7.png))。
...
**図 4**:、マスター ページ、ときに表示をデザイン ビュー ([フルサイズの画像を表示する をクリックします](master-pages-and-site-navigation-cs/_static/image10.png))。
...
**図 10**: 階層ナビゲーション構造を表すサイト マップ ([フルサイズの画像を表示する をクリックします](master-pages-and-site-navigation-cs/_static/image26.png))。
