...
ms.locfileid: "37366107"
---
<a name="including-a-file-upload-option-when-adding-a-new-record-c"></a>新しいレコード (c#) を追加するときに、ファイル アップロード オプションを含める
====================
...
**図 3**: をコピーしてから宣言型構文貼り付けます`DisplayOrDownload.aspx`に`UploadInDetailsView.aspx`([フルサイズの画像を表示する をクリックします](including-a-file-upload-option-when-adding-a-new-record-cs/_static/image6.png))。
...
**図 4**: する必要がありますようになりました「各カテゴリに沿ってのバイナリ データを ([フルサイズ画像を表示する をクリックします。](including-a-file-upload-option-when-adding-a-new-record-cs/_static/image8.png))
...
**図 9**: A 警告メッセージが表示される場合、無効な種類のファイルのアップロード ([フルサイズの画像を表示する をクリックします](including-a-file-upload-option-when-adding-a-new-record-cs/_static/image16.png))。
...
**図 10**: 画像が表示されていない、新しいカテゴリ s ([フルサイズの画像を表示する をクリックします](including-a-file-upload-option-when-adding-a-new-record-cs/_static/image18.png))。
...
**図 11**: の新しいカテゴリの JPG イメージは正しくレンダリング ([フルサイズの画像を表示する をクリックします](including-a-file-upload-option-when-adding-a-new-record-cs/_static/image20.png))。
