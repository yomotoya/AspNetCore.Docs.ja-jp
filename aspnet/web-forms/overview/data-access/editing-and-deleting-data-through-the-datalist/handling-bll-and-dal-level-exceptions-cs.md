...
ms.locfileid: "37368273"
---
<a name="handling-bll--and-dal-level-exceptions-c"></a>BLL レベルと DAL レベルの例外 (c#) の処理
====================
...
**図 5**: An のエラー メッセージが表示されるときに入力を負の価格 ([フルサイズの画像を表示する をクリックします](handling-bll-and-dal-level-exceptions-cs/_static/image13.png))。
