...
**図 2**: The テクノロジ ジャンルのページ ([フルサイズの画像を表示する をクリックします](deploying-a-database-cs/_static/image6.jpg))。
...
**図 3**: のレビューを*教える自分で ASP.NET 3.5 in 24 時間*([フルサイズの画像を表示する をクリックします](deploying-a-database-cs/_static/image9.jpg))。
...
**図 5**: The データベース公開ウィザード スプラッシュ画面 ([フルサイズの画像を表示する をクリックします](deploying-a-database-cs/_static/image15.jpg))。
...
**図 6**: The データベース公開ウィザード スプラッシュ画面 ([フルサイズの画像を表示する をクリックします](deploying-a-database-cs/_static/image18.jpg))。
...
**図 9**: Your Web ホスト プロバイダーのデータベース サーバーへの接続 ([フルサイズの画像を表示する をクリックします](deploying-a-database-cs/_static/image27.jpg))。
...
**図 10**: Your Web ホスト プロバイダーのデータベース サーバーへの接続 ([フルサイズの画像を表示する をクリックします](deploying-a-database-cs/_static/image30.jpg))。
