...
ms.locfileid: "37826495"
---
<a name="interacting-with-the-master-page-from-the-content-page-vb"></a>コンテンツ ページ (VB) からマスター ページと対話します。
====================
...
**図 05**: に新しい ASP.NET ページの追加、`Admin`フォルダー ([フルサイズの画像を表示する をクリックします](interacting-with-the-master-page-from-the-content-page-vb/_static/image15.png))。
