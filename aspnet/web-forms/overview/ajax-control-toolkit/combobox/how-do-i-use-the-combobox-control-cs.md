...
**図 03**: 編集コンボ ボックス アイテム ([フルサイズの画像を表示する をクリックします](how-do-i-use-the-combobox-control-cs/_static/image6.png))。
...
**図 10**: コンボ ボックスが提示され、追加します ([フルサイズの画像を表示する をクリックします](how-do-i-use-the-combobox-control-cs/_static/image20.png))。
