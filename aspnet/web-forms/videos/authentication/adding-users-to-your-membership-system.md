...
---
<a name="adding-users-to-your-membership-system"></a>ユーザーは、メンバーシップ システムを追加します。
====================
によって[行える](https://github.com/JoeStagner)

このビデオで行えるする方法を示しますメンバーシップ リポジトリに新しいユーザーを追加します。

[&#9654;ビデオでは (47 分)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/adding-users-to-your-membership-system)
