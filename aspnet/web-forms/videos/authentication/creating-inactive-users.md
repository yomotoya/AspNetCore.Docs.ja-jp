...
このビデオで行える手順を ASP.NET メンバーシップ システムでの非アクティブなユーザーの作成と管理インターフェイスを使用して、一度に 1 つのユーザーをアクティブ化です。

[&#9654;ビデオでは (23 分)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/creating-inactive-users)
