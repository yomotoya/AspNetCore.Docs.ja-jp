...
ASP.NET AJAX コントロール Toolkit に付属している ASP.NET AJAX ModalPopup エクステンダー コントロールを使用する方法を説明します。 ModalPopup extender が開いたためこのビデオでは、標準の ASP.NET パネルは、モーダル ダイアログ ボックスとして制御します。
