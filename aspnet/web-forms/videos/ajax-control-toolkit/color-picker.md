...
ms.locfileid: "30882726"
---
<a name="color-picker"></a>カラー ピッカー
====================
によって[行える](https://github.com/JoeStagner)

このビデオでは、Microsoft AJAX コントロール Toolkit から新しいカラー ピッカー コントロールを使用する方法をデモンストレーションします。

[&#9654;ビデオでは (9 分)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/color-picker)
