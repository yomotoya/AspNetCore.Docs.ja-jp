...
---
<a name="aspnet-4-quick-hit---imperative-webforms-routing"></a>ASP.NET 4「クイック ヒット」- ルーティング命令型の WebForms
====================
によって[行える](https://github.com/JoeStagner)

このビデオでは、式ビルダーを使用して、WebForms 強制的ルーティングを実行する方法を学習します。 

[&#9654;です。(12 分) のビデオを見る](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-4-quick-hit-imperative-webforms-routing)
