...
---
<a name="aspnet-vnext-videos-model-binding-part-2---filtering"></a>ASP.NET vNext ビデオ: モデル バインド: パート 2 - フィルタ リング
====================
によって[Damian Edwards](https://github.com/DamianEdwards)

このビデオでは、Damian Edwards は、フィルター処理を説明する、モデル バインディングのデモを続行します。
