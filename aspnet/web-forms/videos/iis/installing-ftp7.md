...
---
<a name="installing-ftp7"></a>FTP7 をインストールします。
====================
によって[行える](https://github.com/JoeStagner)

FTP7 は新しい強力です。 このビデオでは、準備して稼働させる方法を示します。

[&#9654;(8 分) のビデオを見る](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/installing-ftp7)
