...
テーブルまたはスタイル シートですか。 相対位置または絶対パスか。 このビデオでは、ページ レイアウトの基本設定の使用による開発をサポートする Visual Web developer の機能を示します。

[&#9654;です。(8 分) のビデオを見る](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/page-layout)
