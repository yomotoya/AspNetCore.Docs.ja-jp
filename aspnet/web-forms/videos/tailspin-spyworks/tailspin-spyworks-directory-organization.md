...
---
<a name="tailspin-spyworks---directory-organization"></a>Tailspin Spyworks - Directory の組織
====================
によって[行える](https://github.com/JoeStagner)

行えるでは、Tailspin Spyworks サンプル Web フォーム アプリケーションの既定のディレクトリ構造を変更します。

[&#9654;ビデオでは (4 分)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/tailspin-spyworks-directory-organization)
