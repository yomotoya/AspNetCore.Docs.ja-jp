...
---
<a name="tailspin-spyworks---adding-user-product-reviews"></a>Tailspin Spyworks - ユーザーの製品のレビューを追加します。
====================
によって[行える](https://github.com/JoeStagner)

行えるでは、レビューを顧客から Tailspin Spyworks サンプルの Web フォーム アプリケーションでの製品の詳細ページに追加します。

[&#9654;ビデオでは (41 分)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/tailspin-spyworks-adding-user-product-reviews)
