...
行えるは、Tailspin Spyworks サンプルの Web フォーム アプリケーションで、ショッピング カートを表示する方法を示します。

[&#9654;です。ビデオでは (15 分)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/tailspin-spyworks-display-shopping-cart)
