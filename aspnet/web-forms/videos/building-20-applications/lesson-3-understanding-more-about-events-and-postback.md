...
このレッスンでは、これらのイベントが発生したときに反応する方法と、コードでイベントを使用する方法を学習します。

[&#9654;ビデオでは (17 分)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/lesson-3-understanding-more-about-events-and-postback)
