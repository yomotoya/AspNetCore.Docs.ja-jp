...
---
<a name="how-do-i-integrate-defect-tracking-with-testing"></a>[How Do i:]欠陥の追跡とテストを統合しますか。
====================
によって[Chris Menegay](https://twitter.com/CMenegay)

このビデオではここを見て、テスト フレームワークの Visual Studio Team System と作業項目追跡システムの間の統合ポイントです。

[&#9654;です。(8 分) のビデオを見る](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-integrate-defect-tracking-with-testing)
