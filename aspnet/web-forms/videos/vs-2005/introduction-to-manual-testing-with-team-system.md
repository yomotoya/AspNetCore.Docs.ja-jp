...
---
<a name="introduction-to-manual-testing-with-team-system"></a>Team System での手動テストの概要
====================
Eric Lee によって

このビデオで作成および手動のテスト Visual Studio Team System の機能を使用して、アプリケーションの手動テスト_ケースを実行する方法を確認します。

[&#9654;です。(8 分) のビデオを見る](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/introduction-to-manual-testing-with-team-system)
