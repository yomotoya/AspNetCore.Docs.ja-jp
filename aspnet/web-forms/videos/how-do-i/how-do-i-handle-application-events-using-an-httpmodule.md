...
ms.locfileid: "26526181"
---
<a name="how-do-i-handle-application-events-using-an-httpmodule"></a>[How Do i:]HttpModule を使用してアプリケーションのイベントを処理しますか。
====================
によって[Chris Pels](https://twitter.com/chrispels)

ページ要求の処理中にアプリケーション イベントを処理する HttpModule を作成する方法を説明します。 サンプル モジュールでは、ページのライフ サイクルのさまざまな時点でのログ ファイルを情報を書き込みます。 サンプル web サイトで使用する HttpModule を構成する方法をも参照してください。

[&#9654;です。ビデオでは (19 分)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-handle-application-events-using-an-httpmodule)
