...
ASP.NET AJAX クライアント ライブラリからスクリプトやコントロールを使用して、クライアント側のプログラミング エクスペリエンスを示しています。 クライアント コントロールは、クライアント側ユーザー インターフェイス エクスペリエンスにアクション、動作、およびデータ バインディングを追加します。
