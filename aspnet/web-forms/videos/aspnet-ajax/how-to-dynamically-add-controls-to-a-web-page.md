...
このビデオでは、web ページにコントロールの不特定の数を動的に追加する方法を示します。

[&#9654;です。ビデオでは (31 分)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-to-dynamically-add-controls-to-a-web-page)
