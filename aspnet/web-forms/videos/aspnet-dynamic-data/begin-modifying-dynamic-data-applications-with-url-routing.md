...
ms.locfileid: "30883493"
---
<a name="begin-modifying-dynamic-data-applications-with-url-routing"></a>URL ルーティングでの動的なデータ アプリケーションの変更を開始します。
====================
によって[行える](https://github.com/JoeStagner)

このビデオでは、ASP.NET 動的データ URL ルーティングについて説明し、ルーティング オプションによって、アプリケーションの URL を構成する方法を示しています。

[&#9654;ビデオでは (5 分)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/begin-modifying-dynamic-data-applications-with-url-routing)
