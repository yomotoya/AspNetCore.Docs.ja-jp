...
<span data-ttu-id="af474-166">ハブで、ユーザーが接続するときに割り当てられているグループを取得します。</span><span class="sxs-lookup"><span data-stu-id="af474-166">In the hub, you retrieve the assigned groups when the user connects.</span></span>
