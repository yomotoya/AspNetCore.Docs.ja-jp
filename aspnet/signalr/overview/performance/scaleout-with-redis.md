...
1. <span data-ttu-id="55b26-129">Redis をインストールし、Redis サーバーを起動します。</span><span class="sxs-lookup"><span data-stu-id="55b26-129">Install Redis and start the Redis server.</span></span>
