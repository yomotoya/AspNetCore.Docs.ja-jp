...
使用する場合[Microsoft JSON 日付形式](https://msdn.microsoft.com/en-us/library/bb299886.aspx#intro_to_json_sidebarb)(`"\/Date(ticks)\/"`) ISO 8601 の代わりに設定する、 **DateFormatHandling**シリアライザーの設定のプロパティ。
