...
---
<a name="supporting-odata-v3-in-aspnet-web-api"></a>ASP.NET Web API の OData v3 のサポート
====================
> ASP.NET Web API を使用すると、OData バージョン 3 をサポートするエンドポイントを作成できます。


- [OData v3 エンドポイントを作成します。](creating-an-odata-endpoint.md)
- [OData v3 のエンティティ関係をサポートします。](working-with-entity-relations.md)
- [Web API 2 OData アクション](odata-actions.md)
- [.NET クライアント (c#) から OData サービスを呼び出す](calling-an-odata-service-from-a-net-client.md)
