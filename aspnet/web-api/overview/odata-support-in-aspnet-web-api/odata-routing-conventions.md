...
3. アクション名が&quot;{EntityType} を取得&quot;ここで、 *{EntityType}* ナビゲーション コレクションの種類です。 たとえば、 &quot;GetSupplier&quot;です。 同様に、任意の名前付け規則を使用する&#8212;のみ確認してください、コント ローラーのアクションと一致します。
