...
---
<a name="use-the-layout-features-in-webmatrix"></a>WebMatrix のレイアウト機能を使用します。
====================
によって[Advaiya](https://twitter.com/Advaiyasolns)

パート 4 では、レイアウトおよび使用する方法できますレイアウト WebMatrix で共通コードをページ全体を説明します。

[&#9654;です。ビデオでは (5 分)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/use-the-layout-features-in-webmatrix)
