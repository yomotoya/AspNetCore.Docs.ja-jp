...
ASP.NET Web プログラミング チュートリアルを使用する、Razor 構文を紹介するビデオ付き

[&#9654;です。ビデオでは (9 分)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/introduction-to-aspnet-web-programming-using-the-razor-syntax)
