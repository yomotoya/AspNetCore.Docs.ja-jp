...
---
<a name="creating-a-consistent-look-part-1"></a>一貫した外観 (パート 1) を作成します。
====================
によって[行える](https://github.com/JoeStagner)

作成するビデオ付き一貫した検索のチュートリアル (パート 1)

[&#9654;ビデオでは (23 分)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/creating-a-consistent-look-part-1)
