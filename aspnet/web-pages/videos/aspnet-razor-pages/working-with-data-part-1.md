...
---
<a name="working-with-data-part-1"></a>データ (パート 1) の使用
====================
によって[行える](https://github.com/JoeStagner)

データのチュートリアル (パート 1) を使用した作業をするビデオ付き

[&#9654;(8 分) のビデオを見る](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/working-with-data-part-1)
