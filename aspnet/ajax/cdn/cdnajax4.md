...
ms.locfileid: "37804961"
---
<a name="aspnet-web-forms-and-ajax-4"></a><span data-ttu-id="154d5-102">ASP.NET Web Forms および Ajax 4</span><span class="sxs-lookup"><span data-stu-id="154d5-102">ASP.NET Web Forms and Ajax 4</span></span>
====================
<span data-ttu-id="154d5-103">次のファイルは、CDN にホストされます。</span><span class="sxs-lookup"><span data-stu-id="154d5-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="154d5-104">注: fr-FR.js など、グローバリゼーション スクリプトは、次のフォルダーに格納されたことができます。</span><span class="sxs-lookup"><span data-stu-id="154d5-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
