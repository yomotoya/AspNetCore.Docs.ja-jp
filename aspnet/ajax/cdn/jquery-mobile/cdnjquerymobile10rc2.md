...
---
<a name="jquery-mobile-10-rc2-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="b0d7c-102">Microsoft Ajax CDN の jQuery Mobile 1.0 RC2</span><span class="sxs-lookup"><span data-stu-id="b0d7c-102">jQuery Mobile 1.0 RC2 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="b0d7c-103">JQuery Mobile 1.0 RC 2 のライブラリには、次のファイルが含まれます。</span><span class="sxs-lookup"><span data-stu-id="b0d7c-103">The jQuery Mobile 1.0 RC 2 library includes the following files:</span></span>
