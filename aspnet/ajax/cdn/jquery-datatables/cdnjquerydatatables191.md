...
---
<a name="jquery-datatables-191"></a><span data-ttu-id="6ca93-102">jQuery 1.9.1 Datatable</span><span class="sxs-lookup"><span data-stu-id="6ca93-102">jQuery DataTables 1.9.1</span></span>
====================
<span data-ttu-id="6ca93-103">CDN では、jQuery プラグインの Datatable には、次のファイルがホストされています。</span><span class="sxs-lookup"><span data-stu-id="6ca93-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
