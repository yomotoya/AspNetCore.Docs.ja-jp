...
ms.locfileid: "37822941"
---
<a name="jquery-datatables-194"></a><span data-ttu-id="f2ddd-102">jQuery Datatable 1.9.4</span><span class="sxs-lookup"><span data-stu-id="f2ddd-102">jQuery DataTables 1.9.4</span></span>
====================
<span data-ttu-id="f2ddd-103">CDN では、jQuery プラグインの Datatable には、次のファイルがホストされています。</span><span class="sxs-lookup"><span data-stu-id="f2ddd-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
