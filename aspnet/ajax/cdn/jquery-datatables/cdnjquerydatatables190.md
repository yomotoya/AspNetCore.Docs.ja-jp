...
title: jQuery Datatable 1.9.0 |Microsoft ドキュメント
...
ms.locfileid: "30072916"
---
<a name="jquery-datatables-190"></a><span data-ttu-id="b55a6-102">JQuery Datatable 1.9.0</span><span class="sxs-lookup"><span data-stu-id="b55a6-102">jQuery DataTables 1.9.0</span></span>
====================
<span data-ttu-id="b55a6-103">CDN では、jQuery Datatable プラグインには、次のファイルがホストされています。</span><span class="sxs-lookup"><span data-stu-id="b55a6-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
