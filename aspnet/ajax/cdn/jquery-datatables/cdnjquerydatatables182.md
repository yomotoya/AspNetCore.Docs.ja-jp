...
ms.locfileid: "30078310"
---
<a name="jquery-datatables-182"></a><span data-ttu-id="6924c-102">jQuery Datatable 1.8.2</span><span class="sxs-lookup"><span data-stu-id="6924c-102">jQuery DataTables 1.8.2</span></span>
====================
<span data-ttu-id="6924c-103">CDN では、jQuery Datatable プラグインには、次のファイルがホストされています。</span><span class="sxs-lookup"><span data-stu-id="6924c-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
