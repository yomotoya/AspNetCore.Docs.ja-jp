...
ms.locfileid: "37830174"
---
<a name="jquery-templates-beta-1"></a><span data-ttu-id="4aac1-102">jQuery テンプレート Beta 1</span><span class="sxs-lookup"><span data-stu-id="4aac1-102">jQuery Templates Beta 1</span></span>
====================
<span data-ttu-id="4aac1-103">JQuery テンプレートのプラグインには、次のファイルが含まれます。</span><span class="sxs-lookup"><span data-stu-id="4aac1-103">The jQuery Templates plugin includes the following files:</span></span>
