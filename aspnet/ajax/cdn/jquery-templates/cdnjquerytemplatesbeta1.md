...
ms.locfileid: "37394535"
---
<a name="jquery-templates-beta-1"></a><span data-ttu-id="d14ba-102">jQuery テンプレート Beta 1</span><span class="sxs-lookup"><span data-stu-id="d14ba-102">jQuery Templates Beta 1</span></span>
====================
<span data-ttu-id="d14ba-103">JQuery テンプレートのプラグインには、次のファイルが含まれます。</span><span class="sxs-lookup"><span data-stu-id="d14ba-103">The jQuery Templates plugin includes the following files:</span></span>
