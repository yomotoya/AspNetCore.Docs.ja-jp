...
ms.locfileid: "30071958"
---
<a name="jquery-validation-1100"></a><span data-ttu-id="edb27-102">jQuery 検証 1.10.0</span><span class="sxs-lookup"><span data-stu-id="edb27-102">jQuery Validation 1.10.0</span></span>
====================
<span data-ttu-id="edb27-103">CDN では、次のファイルがホストされています。</span><span class="sxs-lookup"><span data-stu-id="edb27-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="edb27-104">あるファイルをローカライズhttps://ajax.aspnetcdn.com/ajax/jquery.validate/1.10.0/localization/messages \_##0.00;($# .js 場所 ## loc コードに示します。</span><span class="sxs-lookup"><span data-stu-id="edb27-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.10.0/localization/messages\_##.js where ## is the loc code.</span></span>
