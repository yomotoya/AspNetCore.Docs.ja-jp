...
ms.locfileid: "30070447"
---
<a name="jqueryvalidate-version-18"></a><span data-ttu-id="ea0ed-102">jquery.validate バージョン 1.8</span><span class="sxs-lookup"><span data-stu-id="ea0ed-102">jquery.validate version 1.8</span></span>
====================
<span data-ttu-id="ea0ed-103">CDN では、次のファイルがホストされています。</span><span class="sxs-lookup"><span data-stu-id="ea0ed-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="ea0ed-104">あるファイルをローカライズhttps://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages \_##0.00;($# .js 場所 ## loc コードに示します。</span><span class="sxs-lookup"><span data-stu-id="ea0ed-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages\_##.js where ## is the loc code.</span></span>
