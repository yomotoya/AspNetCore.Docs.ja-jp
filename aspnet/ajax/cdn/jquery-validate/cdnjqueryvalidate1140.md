...
ms.locfileid: "30070486"
---
<a name="jquery-validation-1140"></a><span data-ttu-id="1b432-102">jQuery 検証 1.14.0</span><span class="sxs-lookup"><span data-stu-id="1b432-102">jQuery Validation 1.14.0</span></span>
====================
<span data-ttu-id="1b432-103">CDN では、次のファイルがホストされています。</span><span class="sxs-lookup"><span data-stu-id="1b432-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="1b432-104">あるファイルをローカライズhttps://ajax.aspnetcdn.com/ajax/jquery.validate/1.14.0/localization/messages \_##0.00;($# .js 場所 ## loc コードに示します。</span><span class="sxs-lookup"><span data-stu-id="1b432-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.14.0/localization/messages\_##.js where ## is the loc code.</span></span>
