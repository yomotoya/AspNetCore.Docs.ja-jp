...
ms.locfileid: "30070928"
---
<a name="jquery-validation-1131"></a><span data-ttu-id="c9a36-102">jQuery 検証 1.13.1</span><span class="sxs-lookup"><span data-stu-id="c9a36-102">jQuery Validation 1.13.1</span></span>
====================
<span data-ttu-id="c9a36-103">CDN では、次のファイルがホストされています。</span><span class="sxs-lookup"><span data-stu-id="c9a36-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="c9a36-104">あるファイルをローカライズhttps://ajax.aspnetcdn.com/ajax/jquery.validate/1.13.1/localization/messages \_##0.00;($# .js 場所 ## loc コードに示します。</span><span class="sxs-lookup"><span data-stu-id="c9a36-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.13.1/localization/messages\_##.js where ## is the loc code.</span></span>
