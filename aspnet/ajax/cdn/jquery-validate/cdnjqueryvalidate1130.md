...
---
<a name="jquery-validation-1130"></a>jQuery 検証 1.13.0
====================
...
- あるファイルをローカライズhttps://ajax.aspnetcdn.com/ajax/jquery.validate/1.13.0/localization/messages \_##0.00;($# .js 場所 ## loc コードに示します。
