...
---
<a name="jqueryvalidate-version-17"></a><span data-ttu-id="dc766-102">jquery.validate バージョン 1.7</span><span class="sxs-lookup"><span data-stu-id="dc766-102">jquery.validate version 1.7</span></span>
====================
<span data-ttu-id="dc766-103">CDN では、次のファイルがホストされています。</span><span class="sxs-lookup"><span data-stu-id="dc766-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="dc766-104">ローカライズされたファイル</span><span class="sxs-lookup"><span data-stu-id="dc766-104">Localization Files</span></span>
