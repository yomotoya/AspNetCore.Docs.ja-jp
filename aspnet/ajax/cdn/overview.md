...
====================
注: Microsoft Ajax CDN を持たない SLA の Azure CDN を使用する他にします。
...
- 古い形式: http://ajax.microsoft.com/ajax/jQuery/jquery-1.8.0.js
- 新しい形式: http://ajax.aspnetcdn.com/ajax/jQuery/jquery-1.8.0.js
