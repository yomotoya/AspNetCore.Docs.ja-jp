...
3. **[ASP.NET Web アプリケーション]** プロジェクト テンプレートを選択します。 **[インストール]**、**[テンプレート]**、**[Visual C#]**、**[Web]** の下に表示されます。 プロジェクトに `SampleWebAppDemo` という名前を付けます。 **[Create new Git repository]\(新しい Git リポジトリを作成する\)** オプションを選択し、**[OK]** をクリックします。

   ![[新しいプロジェクト] ダイアログ](azure-continuous-deployment/_static/01-new-project.png)

4. **[新しい ASP.NET プロジェクト]** ダイアログで、ASP.NET Core の **[空]** テンプレートを選択し、**[OK]** をクリックします。
...
2. ナビゲーション ウィンドウの下にある **[参照]** をクリックします。

3. **[Web アプリ]** をクリックし、Azure サブスクリプションに関連付けられている Web アプリの一覧を表示します。

4. このチュートリアルの前のセクションで作成した Web アプリを選択します。

5. **[設定]** ブレードが表示されない場合、**[Web アプリ]** ブレードの **[設定]** を選択します。

6. **[設定]** ブレードで、**[展開元]**、**[ソースの選択]**、**[ローカル Git リポジトリ]** の順に選択します。

   ![[設定] ブレード: [展開元] ブレード: [ソースの選択] ブレード](azure-continuous-deployment/_static/08-azure-localrepository.png)

7. **[OK]** をクリックします。

8. Web アプリや他の App Service アプリを公開するための展開資格情報を設定していない場合、ここで設定してください。
...
9. **[Web アプリ]** ブレードで、**[設定]**、**[プロパティ]** の順にクリックします。 展開するリモート Git リポジトリの URL が **[GIT URL]** の下に表示されます。

10. **GIT URL** の値をコピーします。後で使用します。
...
1. [Azure Portal](https://portal.azure.com) で、Web アプリを選択します。 **[設定]**、**[継続的配置]** の順に選択します。
