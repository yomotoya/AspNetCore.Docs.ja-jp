...
## <a name="remove-ensurecreated"></a>EnsureCreated を削除します。

初期の開発のため、`EnsureCreated`コマンドが使用されました。 このチュートリアルでは、migrations を使用します。 `EnsureCreated`次の limatitions があります。
