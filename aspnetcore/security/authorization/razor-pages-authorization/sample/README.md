...
このサンプルではユーザーの承認で説明されている機能の cookie 認証を使用して、 [ASP.NET Core Id なしの Cookie 認証を使用して](https://docs.microsoft.com/aspnet/core/security/authentication/cookie)トピックです。 ASP.NET Core Id の使用方法の詳細については、トピックを参照して、[認証](https://docs.microsoft.com/aspnet/core/security/authentication/index)ドキュメントのセクションでします。
