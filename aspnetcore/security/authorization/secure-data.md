...
このチュートリアルの場合と、ダウンロード コードには、ASP.NET Core 2.2 プレビュー 1 以降が必要です。 参照してください[この GitHub の問題](https://github.com/aspnet/Identity/issues/1813#issuecomment-394543909)を回避します。
