...
[表示またはダウンロードするサンプル コード](https://github.com/aspnet/Docs/tree/master/aspnetcore/fundamentals/localization/sample/POLocalization)([をダウンロードする方法](xref:tutorials/index#how-to-download-a-sample))
