...
<span data-ttu-id="a5cac-208">`Map` では、次のように一度に複数のセグメントを照合できます。</span><span class="sxs-lookup"><span data-stu-id="a5cac-208">`Map` can also match multiple segments at once:</span></span>
