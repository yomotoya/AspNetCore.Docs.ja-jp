# <a name="custom-webhost-service-sample"></a><span data-ttu-id="97aad-101">カスタム WebHost サービスのサンプル</span><span class="sxs-lookup"><span data-stu-id="97aad-101">Custom WebHost Service Sample</span></span>
