## <a name="register-the-database-context"></a><span data-ttu-id="f650a-101">データベース コンテキストの登録</span><span class="sxs-lookup"><span data-stu-id="f650a-101">Register the database context</span></span>
