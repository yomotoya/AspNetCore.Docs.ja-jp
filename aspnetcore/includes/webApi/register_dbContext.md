## <a name="register-the-database-context"></a><span data-ttu-id="62a45-101">データベース コンテキストの登録</span><span class="sxs-lookup"><span data-stu-id="62a45-101">Register the database context</span></span>
