...
ms.locfileid: "30893899"
---
[!INCLUDE [adding-model](../../includes/mvc-intro/sql.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="4be99-103">[前 - モデルの追加](adding-model.md)
> [次 - コントローラーのメソッドとビュー](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="4be99-103">[Previous - Add a model](adding-model.md)
