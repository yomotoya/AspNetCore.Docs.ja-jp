...
<span data-ttu-id="65c3c-104">[前 - モデルの追加](adding-model.md)
[次 - コントローラーのメソッドとビュー](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="65c3c-104">[Previous - Add a model](adding-model.md)
