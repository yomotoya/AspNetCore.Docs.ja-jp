...
ms.locfileid: "36279091"
---
[!INCLUDE [adding-model](../../includes/mvc-intro/sql.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="18b67-103">[前 - モデルの追加](adding-model.md)
> [次 - コントローラーのメソッドとビュー](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="18b67-103">[Previous - Add a model](adding-model.md)
