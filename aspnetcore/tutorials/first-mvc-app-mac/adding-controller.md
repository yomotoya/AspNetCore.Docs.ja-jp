...
ms.locfileid: "36279481"
---
# <a name="add-a-controller-to-an-aspnet-core-mvc-app-with-visual-studio-for-mac"></a>Visual Studio for Mac を使用して ASP.NET Core MVC アプリにコントローラーを追加する
