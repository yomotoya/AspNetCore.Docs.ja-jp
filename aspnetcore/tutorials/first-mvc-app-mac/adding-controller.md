...
keywords: "ASP.NET Core, MVC, コントローラー"
ms.author: riande
manager: wpickett
ms.date: 06/28/2017
ms.topic: article
...
---
# <a name="adding-a-controller-to-an-aspnet-core-mvc-app-with-visual-studio-for-mac"></a>Visual Studio for Mac を使用して ASP.NET Core MVC アプリにコントローラーを追加する
