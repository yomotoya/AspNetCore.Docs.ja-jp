...
> <span data-ttu-id="a09ee-103">[前: ページの更新](xref:tutorials/razor-pages-vsc/da1)
> [次: 新しいフィールドの追加](xref:tutorials/razor-pages/new-field)</span><span class="sxs-lookup"><span data-stu-id="a09ee-103">[Previous: Updating the pages](xref:tutorials/razor-pages-vsc/da1)
