...
> <span data-ttu-id="61094-103">[前: モデルの追加](xref:tutorials/razor-pages-vsc/model)
> [次: ページの更新](xref:tutorials/razor-pages-vsc/da1)</span><span class="sxs-lookup"><span data-stu-id="61094-103">[Previous: Adding a model](xref:tutorials/razor-pages-vsc/model)
