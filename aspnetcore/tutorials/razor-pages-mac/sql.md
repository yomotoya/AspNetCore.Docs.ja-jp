...
ms.locfileid: "31483920"
---
[!INCLUDE [SQLlite](../../includes/RP/sql.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="85412-103">[前: モデルの追加](xref:tutorials/razor-pages-mac/model)
> [次: ページの更新](xref:tutorials/razor-pages-mac/da1)</span><span class="sxs-lookup"><span data-stu-id="85412-103">[Previous: Adding a model](xref:tutorials/razor-pages-mac/model)
