...
> <span data-ttu-id="dfefe-103">[前 - モデルの追加](adding-model.md)
> [次 - コントローラーのメソッドとビュー](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="dfefe-103">[Previous - Add a model](adding-model.md)
