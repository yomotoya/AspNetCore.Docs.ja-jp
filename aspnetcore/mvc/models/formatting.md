...
## <a name="response-format-url-mappings"></a><span data-ttu-id="c6592-211">応答の形式の URL マッピング</span><span class="sxs-lookup"><span data-stu-id="c6592-211">Response Format URL Mappings</span></span>
